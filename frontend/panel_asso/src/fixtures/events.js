...
let events = [
  {id: 1, title: "Titre d'un évènement", content: "Some content...",
    author: "Célian Cusey", tags: [1, 2], startDate: Date.now() / 1000,
    endDate: Date.now() / 1000, recurrent: false, frequency: 0, endRecurrence: Date.now() / 1000},
  {id: 2, title: "Deuxième exemple de titre d'évènement", content: "Some content...",
    author: "Nathan Lenogue", tags: [4, 5], startDate: Date.now() / 1000,
    endDate: Date.now() / 1000, recurrent: false, frequency: 0, endRecurrence: Date.now() / 1000}
];
