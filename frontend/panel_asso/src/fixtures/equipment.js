...
const users = [
  ...
  {
    id: 'ezferttrg',
    login: 'vincent1.barbier',
    email: 'vincent1.barbier@epita.fr',
    name: 'Vincent',
    lastName: 'Barbier',
    school: 'EPITA',
    isAdmin: false
...
let equipmentRequests = [
  {
    id: 1,
    equipmentId: 2,
    equipmentName: 'Enceinte',
    userRespoOwner: users[0],
    assoBorrower: assos[1],
    userRespoBorrower: users[2],
    borrowingDate: 1717236000,
    dueDate: 1717840800,
    status: 'accepted',
  ...
  },
  {
    id: 2,
    equipmentId: 7,
    equipmentName: 'Multi-prise',
    userRespoOwner: users[2],
    assoBorrower: assos[2],
    userRespoBorrower: users[4],
    borrowingDate: 1717495200,
    dueDate: 1718013600,
    status: 'accepted',
    comment: ''
  },
  ...
  },
  {
    ...
    userRespoOwner: users[4],
    assoBorrower: assos[0],
    userRespoBorrower: users[3],
    borrowingDate: 1717495200,
    dueDate: 1718186400,
    status: 'accepted',
    comment: ''
  ...
  },
  {
    id: 5,
    equipmentId: 3,
    equipmentName: 'Ecocup WEI',
    userRespoOwner: users[0],
    assoBorrower: assos[2],
    userRespoBorrower: users[4],
    borrowingDate: 1717257600,
    dueDate: 1717344000,
    status: 'accepted',
    comment: ''
  },
  ...
  },
  {
    id: 8,
    equipmentId: 9,
    equipmentName: 'Crêpière grise',
    userRespoOwner: users[1],
    assoBorrower: assos[0],
    userRespoBorrower: users[3],
    borrowingDate: 1718035200,
    dueDate: 1719266400,
    status: 'accepted',
    comment: 'Rendez la propre svp c:'
  }
]
...
let equipment = [
  ...
  },
  {
    ...
    assoOwner: assos[0],
    quantity: 1,
    equipmentRequest: equipmentRequests[0],
    photo:
      'https://proxymedia.woopic.com/api/v1/images/1618%2Fedithor%2Faccessoires%2F504x504-LD0005793816_1_624ed828be29591e39e9ab10.png?format=504x504&saveas=webp&saveasquality=80'
  },
  {
    id: 3,
    name: 'Ecocup WEI',
  ...
  { id: 5, name: 'Enrouleur', assoOwner: assos[1], quantity: 1, equipmentRequest: null, photo: '' },
  {
    ...
    assoOwner: assos[1],
    quantity: 1,
    equipmentRequest: equipmentRequests[2],
    photo:
      'https://content.pearl.fr/media/cache/default/article_ultralarge_high_nocrop/shared/images/articles/K/KT8/multiprise-avec-3-prises-230-v-et-interrupteur-blanc-ref_KT8583_1.jpg'
  },
  {
    id: 7,
    name: 'Multi-prise',
    assoOwner: assos[1],
    quantity: 1,
    equipmentRequest: equipmentRequests[1],
    photo:
      'https://content.pearl.fr/media/cache/default/article_ultralarge_high_nocrop/shared/images/articles/K/KT8/multiprise-avec-3-prises-230-v-et-interrupteur-blanc-ref_KT8583_1.jpg'
  },
  ...
  { id: 15, name: 'Glacière', assoOwner: assos[1], quantity: 1, equipmentRequest: null, photo: '' },
  {
    ...
    assoOwner: assos[1],
    quantity: 1,
    equipmentRequest: equipmentRequests[7],
    photo: ''
  },
  {
    id: 10,
    name: 'Crêpière verte n1',
    assoOwner: assos[1],
    quantity: 1,
    equipmentRequest: null,
    photo: ''
  ...
  },
  {
    ...
    assoOwner: assos[2],
    quantity: 1,
    equipmentRequest: equipmentRequests[3],
    photo: ''
  },
...
fixture('POST /api/equipment/{equipmentId}/borrow', (request, response) => {
  ...
  if (index !== -1) {
    ...
    newEquipmentRequest.userRespoBorrower = {
      id: 'regrrreg',
      login: 'celian.cusey',
      email: 'celian.cusey@epita.fr',
      name: 'Célian',
      ...
      school: 'EPITA',
      isAdmin: false
    } // Dans le backend, prendre le user qui fait la request
...
fixture('POST /api/equipment/{id}/invalid-dates', (request) => {
  ...
  return equipmentRequests
    .filter((req) => req.equipmentId === id && req.status === 'accepted')
