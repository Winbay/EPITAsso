  ...
  if (props.article) {
    ...
    try {
      ...
      toast.add({ severity: 'error', summary: 'Articles',
        detail: "L'article n'a pas pu être modifié.", life: 3000 });
      console.log(error);
      return false
    }
  } else {
    ...
    try {
      ...
      toast.add({ severity: 'error', summary: 'Articles',
        detail: "L'article n'a pas pu être créé.", life: 3000 });
      console.log(error);
      return false
    }
  }
...
<template>
  <Dialog class="dialog-event h-full" modal @update:visible="cancelDialog"
    ...
    <div class="title mb-6 flex flex-col justify-start">
      ...
      <InputText id="title" v-model="currArticle.title" aria-describedby="username-help" placeholder="Titre de l'article"
    ...
    <div class="mb-6 flex flex-col justify-start w-8/12">
      ...
      <MultiSelect v-model="currArticle.tags" :options="props.tags" option-label="name" option-value="id" display="chip"/>
    </div>
    <div class="mb-6 flex flex-col justify-start">
      <div class="flex justify-start items-center">
        ...
        <Button :label="props.article ? 'Sauvegarder' : 'Créer'" severity="success"
