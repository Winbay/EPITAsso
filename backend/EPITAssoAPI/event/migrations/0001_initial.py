    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_members', models.ManyToManyField(related_name='events_staff', to=settings.AUTH_USER_MODEL)),
                ('event_sheet', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='event.eventsheet')),
